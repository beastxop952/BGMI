...
TOKEN = '7541504076:AAEC1hZEDe6iii2FOkU2kw9ytdqOsFEBpEE'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002302996570
CHANNEL_ID = -1002302996570
error_channel_id = -1002302996570
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/ACECHEAT1/17045*", parse_mode='Markdown')
